...
!(function (e, t) {
    ...
    (we = we && we.hasOwnProperty("default") ? we["default"] : we),
        ...
        (we.VIDEO_PROVIDERS = [
        {
                test_regex: /^.+(cloudflarestream.com)\/[^_&]+/,
                url_regex: "",
                url_text: "",
                html: '<iframe width="640" height="360" src="{url}" allow="accelerometer; gyroscope; autoplay; encrypted-media; picture-in-picture;" allowfullscreen="true"></iframe>',
        ...
        (we.PLUGINS.video = function (w) {
            ...
            function r() {
                ...
                if (
                    ...
                    var t = E.find("iframe, embed, ".concat(E.find("iframe, embed, audio").get(0) ? "audio" : "video")),
                        ...
                        a = t.get(0).src ? t.get(0).src : t.get(0).currentSrc,
                        r = !(!(a = (a = a.split("."))[a.length - 1]).includes("pdf") && !a.includes("txt"));
                    t.hasClass("fr-file") || r || E.find("audio").get(0)
            ...
            function n(e) {
                ...
                var i,
                    a = "",
                    r = w.opts.videoInsertButtons.indexOf("videoUpload"),
                    n = w.opts.videoInsertButtons.indexOf("videoByURL"),
                    s = w.opts.videoInsertButtons.indexOf("videoEmbed");
                if (0 <= n) {
                    (i = " fr-active"), ((r < n && 0 <= r) || (s < n && 0 <= s)) && (i = "");
                    a = '<div class="fr-video-by-url-layer fr-layer'
            ...
            function x(s, e, d, l, p) {
                w.edit.off(), b("Loading video"), e && (s = w.helpers.sanitizeURL(s));
                var f = function f() {
                    var e, t;
                    if (l) {
                        ...
                        if ((l.data("fr-replaced", !1), 0 < l.find("iframe").length)) l.remove(), (e = k(s, d, m));
                        else {
                            ...
                            e.find("video").on("canplay", m), e.find("video").attr("src", s);
                        }
                        w.edit.on(), L(), w.undo.saveStep(), w.$el.blur(), w.events.trigger(i ? "video.replaced" : "video.inserted", [e, p]);
                    } else (e = k(s, d, m)), L(), w.undo.saveStep(), w.events.trigger("video.inserted", [e, p]);
                };
                R("Loading video"), f();
            }
            function R(e) {
                ...
                if ((t || (t = n()), t.find(".fr-layer.fr-active").removeClass("fr-active").addClass("fr-pactive"), t.find(".fr-video-progress-bar-layer").addClass("fr-active"), t.find(".fr-buttons").hide(), E)) {
                    ...
                    w.popups.show("video.insert", i, a, o.outerHeight());
                }
                    ...
                    if (w.opts.videoUploadToS3 || w.opts.videoUploadToAzure)
                        if (201 == i) {
                            ...
                            if (w.opts.videoUploadToAzure) {
                                if (!1 === w.events.trigger("video.uploadedToAzure", [this.responseURL, o, a], !0)) return w.edit.on(), !1;
                                s = t;
                            } else
                                s = (function l(e) {
                                    try {
            ...
            function D(e) {
                if (e.lengthComputable) {
                    ...
                    b(w.language.translate("Uploading"), t);
                }
            }
            function I() {
                w.edit.on(), d(!0);
            ...
            const isValidUrl = urlString=> {
                    var urlPattern = new RegExp(/^.+(cloudflarestream.com)\/[^_&]+/); // validate fragment locator
            ...
            function k(e, t, o) {
                var i,
                    a = "";
                if (t && void 0 !== t) for (i in t) t.hasOwnProperty(i) && "link" != i && (a += " data-".concat(i, '="').concat(t[i], '"'));
                var r = w.opts.videoDefaultWidth;
                r && "auto" != r && (r = "".concat(r, "px")), w.helpers.isMobile() && w.browser.safari && (a += " autoplay playsinline");
                ...
                if(isValidUrl(e))
                    {
                        n.html('<iframe width="640" height="360" src="'+e+'" allow="accelerometer; gyroscope; autoplay; encrypted-media; picture-in-picture;" allowfullscreen="true"></iframe>');
                    }
                else{
                        n.html('<video src="' + e + '" ' + a + (r ? ' style="width: ' + r + ';" ' : "") + " controls>" + w.language.translate("Your browser does not support HTML5 video.") + "</video>");
                    }
//                    .html('<video src="' + e + '" ' + a + (r ? ' style="width: ' + r + ';" ' : "") + " controls>" + w.language.translate("Your browser does not support HTML5 video.") + "</video>");
                n.toggleClass("fr-draggable", w.opts.videoMove), w.edit.on(), w.events.focus(!0), w.selection.restore(), w.undo.saveStep(), w.opts.videoSplitHTML ? w.markers.split() : (w.cursor.enter(), w.markers.insert()), w.html.wrap();
            ...
            function T(e) {
                ...
                if ("mousedown" == e.type) {
                    ...
                    r && a.frameElement && ((t += w.helpers.getPX(A(a.frameElement).offset().left) + a.frameElement.clientLeft), (o = e.clientY + w.helpers.getPX(A(a.frameElement).offset().top) + a.frameElement.clientTop));
                }
            ...
            function z(e) {
                ...
                if (p) {
                    ...
                    var r = t - i,
                        ...
                        d = s.width(),
                        l = s.height();
                    (p.hasClass("fr-hnw") || p.hasClass("fr-hsw")) && (r = 0 - r),
                            ...
                            w.events.on("keydown", function (e) {
                                if (E) {
                                    var t = -1 != navigator.userAgent.indexOf("Mac OS X") ? e.metaKey : e.ctrlKey,
                                        o = e.which;
                                    (o !== a || 200 < e.timeStamp - r) && (i = 1),
                                        (o == we.KEYCODE.EQUALS || (w.browser.mozilla && o == we.KEYCODE.FF_EQUALS)) && t && !e.altKey
                                            ? (i = O.call(this, e, 1, 1, i))
                                            : (o == we.KEYCODE.HYPHEN || (w.browser.mozilla && o == we.KEYCODE.FF_HYPHEN)) && t && !e.altKey && (i = O.call(this, e, 2, -1, i)),
                                        (a = o),
                                        (r = e.timeStamp);
                                }
                            }),
                    ...
                    if (!((null !== w.opts.videoUploadURL && w.opts.videoUploadURL != C) || w.opts.videoUploadToS3 || w.opts.videoUploadToAzure))
                        return (
                            (function y(i) {
                                ...
                                (a.onload = function () {
                                    a.result;
                                    for (var e = atob(a.result.split(",")[1]), t = [], o = 0; o < e.length; o++) t.push(e.charCodeAt(o));
                        ...
                        if (w.opts.videoUploadToAzure) {
                            ...
                            if (!w.opts.videoUploadToAzure.SASToken && w.opts.videoUploadToAzure.accessKey) {
                                ...
                                var v = "x-ms-blob-type:BlockBlob\nx-ms-date:".concat(l, "\nx-ms-version:2019-07-07"),
                                    ...
                                    m = "SharedKey " + p + ":" + h;
                                (r = h), d.setRequestHeader("Authorization", m);
                            }
            ...
            function F(e, t) {
                if(!isValidUrl(JSON.parse(t).link))
                {
                    w.edit.on(), E && E.find("video").addClass("fr-error"), y(w.language.translate("Something went wrong. Please try again.")), w.events.trigger("video.error", [{ code: e, message: a[e] }, t]);
                }else{
                    setTimeout(document.querySelector(".fr-video-progress-bar-layer").classList.remove("fr-active"),5000);
                }
            }
            function X() {
                if (E) {
            ...
            function Q() {
                ...
                if (0 != e.length) {
                    ...
                    for (var t, o, i, a, r = w.$el.find("span.fr-video, video"), n = 0; n < r.length; n++) {
                        var s = A(r[n]);
                        !w.opts.htmlUntouched && w.opts.useClasses
                            ? ((a = s).hasClass("fr-dvi") || a.hasClass("fr-dvb") || (a.addClass("fr-fv".concat(j(a)[0])), a.addClass("fr-dv".concat(W(a)[0]))), w.opts.videoTextNear || s.removeClass("fr-dvi").addClass("fr-dvb"))
            ...
            return (
                ...
                (a[c] = "No link in upload response."),
                (a[v] = "Error during file upload."),
                (a[u] = "Parsing response failed."),
                (a[S] = "File is too large."),
                (a[U] = "Video file type is invalid."),
                ...
                (w.shared.vid_exit_flag = !1),
                {
                    _init: function oe() {
                        w.opts.videoResponsive && (w.opts.videoResize = !1),
                            ...
                            w.$wp && (L(), w.events.on("contentChanged", L)),
                            n(!0),
                            G(!0);
                    },
                    ...
                    showLayer: function ae(e) {
                        ...
                        if (!E && !w.opts.toolbarInline) {
                            var a = w.$tb.find('.fr-command[data-cmd="insertVideo"]');
                            (t = a.offset().left), (o = a.offset().top + (w.opts.toolbarBottom ? 10 : a.outerHeight() - 10));
                        }
                    ...
                    insertByURL: function de(e) {
                        ...
                        if (void 0 === e) {
                            var o = (e = (w.popups.get("video.insert").find('.fr-video-by-url-layer input[type="text"]').val() || "").trim()).match(
                                /(https?:\/\/)?(www\.)?(player\.)?vimeo\.com\/?(showcase\/)*([0-9))([a-z]*\/)*([0-9]{6,11})[?]?.*/
                            );
                            if (o && 7 == o.length) {
                                var i = o[6],
                                    a = e.substring(0, e.lastIndexOf("/")),
                                    r = e.substring(e.lastIndexOf("/") + 1, e.length);
                                e = r.includes("?h=") || r.includes("?v=") || i === r ? ("".concat(a, "/").concat(r) || "").trim() : ("".concat(a, "?h=").concat(r) || "").trim();
                            }
                        }
                        var n = null;
                        if ((/^http/.test(e) || (e = "https://".concat(e)), w.helpers.isURL(e)))
                            for (var s = 0; s < we.VIDEO_PROVIDERS.length; s++) {
                                var d = we.VIDEO_PROVIDERS[s],
                                    l = "autoplay=1&mute=1";
                                if (d.html.includes("autoplay=1") && document.getElementById("videoPluginAutoplay").checked) (d.html = d.html), (document.getElementById("videoPluginAutoplay").checked = !1);
                                else if (t) {
                                    var p = d.html.indexOf("{url}") + 5;
                                    (d.html = [d.html.slice(0, p), l, d.html.slice(p)].join("")), (t = !1), (document.getElementById("videoPluginAutoplay").checked = !1);
                                } else (d = we.VIDEO_PROVIDERS[s]).html = d.html.replace(l, "");
                                if (d.test_regex.test(e) && new RegExp(w.opts.videoAllowedProviders.join("|")).test(d.provider)) {
                                    (n = e.replace(d.url_regex, d.url_text)), (n = d.html.replace(/\{url\}/, n));
                                    break;
                                }
                            }
                        n ? h(n) : (y(w.language.translate("Something went wrong. Please try again.")), w.events.trigger("video.linkError", [e]));
                    },
                    insertEmbed: function le(e) {
                        void 0 === e && (e = w.popups.get("video.insert").find(".fr-video-embed-layer textarea").val() || ""),
                            0 !== e.length && we.VIDEO_EMBED_REGEX.test(e) ? h(e) : (y(w.language.translate("Something went wrong. Please try again.")), w.events.trigger("video.codeError", [e]));
                    },
                    insert: h,
                    align: function pe(e) {
        ...
        we.RegisterCommand("videoBack", {
            ...
            refresh: function (e) {
                this.video.get() || this.opts.toolbarInline
                    ? (e.removeClass("fr-hidden"), e.next().hasClass("fr-separator") && e.next().removeClass("fr-hidden"))
                    : (e.addClass("fr-hidden"), e.next().hasClass("fr-separator") && e.next().addClass("fr-hidden"));
            },
        }),
